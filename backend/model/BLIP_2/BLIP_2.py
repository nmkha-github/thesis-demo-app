...
from model.BLIP_2.BLIP_2_vision import clip_joint_l14
from model.BLIP_2.BLIP_2_text import clip_text_l14
...
class BLIP_2(nn.Module):
    def __init__(
        self,
        tokenizer=None,
        pretrain=os.path.join(os.path.dirname(os.path.abspath(__file__)), "BLIP_2.pth"),
        freeze_text=True,
    ):
        super(BLIP_2, self).__init__()
        if tokenizer:
